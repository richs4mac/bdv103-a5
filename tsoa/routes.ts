...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { HelloController } from './../src/hello/helloController.js';
...
export function RegisterRoutes(router: KoaRouter) {
    ...
    // ###########################################################################################################
        ...
        router.get('/hello/:name',
            ...
            ...(fetchMiddlewares<Middleware>(HelloController.prototype.getHello)),

            async function HelloController_getHello(context: Context, next: Next) {

            let validatedArgs: any[] = [];
            try {
              validatedArgs = templateService.getValidatedArgs({ args: argsHelloController_getHello, context, next });
            } catch (err) {
